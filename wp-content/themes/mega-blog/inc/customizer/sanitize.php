...
if ( ! function_exists( 'mega_blog_sanitize_select' ) ) :
	/**
	 ...
	 */
	function mega_blog_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'mega_blog_sanitize_image' ) ) :
	/**
	 ...
	 */
	function mega_blog_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'mega_blog_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function mega_blog_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'mega_blog_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Mega Blog 1.0.0
	*/
	function mega_blog_sanitize_page( $input ) {
...
if ( ! function_exists( 'mega_blog_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Mega Blog 1.0.0
	 ...
	 */
	function mega_blog_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'mega_blog_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Mega Blog 1.0.0
	 */
	function mega_blog_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'mega_blog_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Mega Blog 1.0.0
	 */
	function mega_blog_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'mega_blog_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function mega_blog_santize_allow_tag( $input ) {
...
if ( ! function_exists( 'mega_blog_sanitize_post_ids' ) ) :
	/**
	* Sanitizes post ids
	* @param  $input entered value
	* @return sanitized output
	...
	* @since Mega Blog 1.0.0
	*/
	function mega_blog_sanitize_post_ids( $input ) {
 ...
 * @return boolean    
 */
function mega_blog_sanitize_switch_control( $input ) {
...
* @since Mega Blog 1.0.0
*/
function mega_blog_sanitize_links( $input ) {
...
* @since Mega Blog 1.0.0
*/
function mega_blog_sanitize_email( $input ) {
 ...
 */
function mega_blog_sanitize_range_value( $input ) {
	if ( mega_blog_json( $input ) ) {
